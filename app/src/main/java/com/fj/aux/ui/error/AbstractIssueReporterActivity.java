...
public abstract class AbstractIssueReporterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.fj.aux.R.layout.air_activity_issue_reporter);
        findViews();
    ...
    private void initViews() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(com.fj.aux.R.string.text_issue_report);
        }
    ...
    public void finish() {
        if (mCrash) {
            if (!mReportFailed) {
                Toast.makeText(this, com.fj.aux.R.string.text_report_succeed, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, com.fj.aux.R.string.text_report_fail, Toast.LENGTH_SHORT).show();
            }
            finishAffinity();
        } else {
            super.finish();
