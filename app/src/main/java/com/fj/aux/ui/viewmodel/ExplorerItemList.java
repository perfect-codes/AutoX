...
public class ExplorerItemList {
    ...
    public static class SortConfig {
        ...
        private static final String CLASS_NAME = "com.fj.aux.ui.viewmodel.ScriptList.SortConfig";
