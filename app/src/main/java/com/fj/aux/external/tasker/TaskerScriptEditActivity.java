package com.fj.aux.external.tasker;
...
import com.fj.aux.R;
import com.fj.aux.timing.TaskReceiver;
import com.fj.aux.tool.Observers;
import com.fj.aux.ui.BaseActivity;
import com.fj.aux.ui.edit.EditorView;
...
import static com.fj.aux.ui.edit.EditorView.EXTRA_CONTENT;
import static com.fj.aux.ui.edit.EditorView.EXTRA_NAME;
import static com.fj.aux.ui.edit.EditorView.EXTRA_RUN_ENABLED;
import static com.fj.aux.ui.edit.EditorView.EXTRA_SAVE_ENABLED;
...
public class TaskerScriptEditActivity extends BaseActivity {
    ...
    @Override
    public void finish() {
        setResult(Activity.RESULT_OK, new Intent().putExtra(EXTRA_CONTENT, mEditorView.getEditor().getText()));
